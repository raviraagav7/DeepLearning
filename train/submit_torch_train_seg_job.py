...
def upload_data2azure(ds, src_dir, target_dir='wiredata'):
    """
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Train a Segmentation using Torch')
    ...
    experiment = Experiment(workspace=ws, name='train_torch_segmentation')

    script_params = {
        '--data_dir': ds.path('wiredata').as_mount(),
    ...
    script_folder = os.path.join(os.path.dirname(__file__), 'torch', 'segmentation')
